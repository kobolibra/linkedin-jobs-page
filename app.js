...
function renderTop50(rows){
  ...
  const diagonal='<line class="bubble-diagonal" x1="'+x(0)+'" y1="'+y(0)+'" x2="'+x(domainMax)+'" y2="'+y(domainMax)+'"/><text class="bubble-relation bubble-relation-above" x="'+x(11)+'" y="'+y(15)+'" text-anchor="middle">MEDIAN &gt; AVERAGE</text><text class="bubble-relation bubble-relation-below" x="'+x(11)+'" y="'+y(7)+'" text-anchor="middle">AVERAGE &gt; MEDIAN</text>';
