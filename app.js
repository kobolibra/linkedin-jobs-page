...
function renderTop50(rows){
  ...
  const wireRamp=['#6B6A65','#7F7E78','#96958E','#AEADA5','#C6C5BE','#DAD9D2'];
  ...
  host.innerHTML='<svg class="top20-svg" viewBox="0 0 '+W+' '+H+'" role="img" aria-label="职位数量最多的 20 家公司散点图，横轴为职位数量">'+grid+rowsSvg+'</svg>';
